...
\tikzset{hydra/.pic={
\node () at (0,0) {\includegraphics[scale=3.0]{Images/hydra.png}};
}}

\tikzset{crown/.pic={
\node[transform shape] () at (0,0) {\includegraphics[scale=0.4]{Images/crown.png}};
}}

\tikzset{orb/.pic={
\node[transform shape] () at (0,0) {\includegraphics[scale=0.575]{Images/orb.png}};
}}
