...
\colorlet{Regalia}{Orange}
\colorlet{Arcanum}{Purple}
\colorlet{Country}{Brown}
...
\pic () at (0,0) {cardbackprintable={Regalia}};
\pic () at (\horizdist,0) {cardbackprintable={Regalia}};
\pic () at (2\horizdist,0) {cardbackprintable={Regalia}};
