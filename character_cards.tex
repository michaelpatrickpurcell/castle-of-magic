...
\tikzset{seahorse/.pic={
\node () at (0,0) {\includegraphics[scale=3.1]{Images/seahorse.png}};%1.5]{Images/dragon.png}};
}}
...
%
%\pic () at (0,-\vertdist) {cardbackprintable={Intrigue}};
%\pic () at (\horizdist,-\vertdist) {cardbackprintable={Intrigue}};
%\pic () at (2\horizdist,-\vertdist) {cardbackprintable={Intrigue}};
%
%\pic () at (0,-2\vertdist) {cardbackprintable={Intrigue}};
%\pic () at (\horizdist,-2\vertdist) {cardbackprintable={Intrigue}};
%\pic () at (2\horizdist,-2\vertdist) {cardbackprintable={Intrigue}};
%
%\end{tikzpicture}	
%\end{center}
%\newpage
